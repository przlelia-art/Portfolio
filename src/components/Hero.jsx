  ...
  return (
    <>
      <style>{`
        ...
        /* Positionnés de manière stable par rapport au centre */
        .bg-word.left {
          top: 15%;
          left: calc(50% - 780px);
        ...
        /* --- CARTES LATÉRALES POSITIONNÉES AU CENTRE --- */
        .side-card {
          position: absolute;
          display: flex;
        ...
        /* Placement horizontal fixe par rapport à ton bloc central */
        .side-card.orange-accent { 
          left: calc(50% - 490px);
          border-left: 3px solid #ff5e3a; 
          box-shadow: -15px 0 40px rgba(255,94,58,0.04);
        }
        .side-card.cyan-accent { 
          right: calc(50% - 490px);
          border-right: 3px solid #00d9ff; 
          box-shadow: 15px 0 40px rgba(0,217,255,0.04);
        }

        /* Responsive : On bascule proprement si l'écran rétrécit */
        @media (max-width: 1280px) {
          .side-card.orange-accent { left: 24px; }
          .side-card.cyan-accent { right: 24px; }
          .bg-word { font-size: 130px; }
          .bg-word.left { left: calc(50% - 600px); }
          .bg-word.right { right: calc(50% - 580px); }
        }
      ...
      >
        {/* Halos de lumière géants en arrière-plan (z-index: 0 pour rester TOUT DERRIÈRE) */}
        <div style={{
          position: "absolute", width: "900px", height: "900px", borderRadius: "50%",
          background: "radial-gradient(circle, rgba(255,94,58,0.1) 0%, transparent 75%)",
          top: "-15%", left: "-10%", pointerEvents: "none", zIndex: 0
        }} />
        <div style={{
          position: "absolute", width: "900px", height: "900px", borderRadius: "50%",
          background: "radial-gradient(circle, rgba(0,217,255,0.08) 0%, transparent 75%)",
          bottom: "-15%", right: "-10%", pointerEvents: "none", zIndex: 0
        }} />

        {/* Conteneur des mots en arrière-plan */}
        <div className="bg-word-container">
          <div className="bg-word left">DRIVE</div>
          <div className="bg-word right">DANCE</div>
        </div>

        {/* Speedlines (Lignes de phares / vitesse) */}
        <div className="speedline orange" style={{ top: "22%", left: 0, width: "320px" }} />
        <div className="speedline orange" style={{ top: "25%", left: 0, width: "160px", opacity: 0.2 }} />
        <div className="speedline cyan"   style={{ top: "68%", right: 0, width: "340px" }} />
        <div className="speedline cyan"   style={{ top: "71%", right: 0, width: "180px", opacity: 0.2 }} />

        {/* SVG des tracés de circuits (Centré au milieu du Hero et agrandi pour habiller l'espace) */}
        <div style={{ position: "absolute", inset: 0, width: "100%", height: "100%", zIndex: 2, pointerEvents: "none" }}>
          ...
          >
            {/* Tracé Circuit Gauche (Orange) */}
            <path 
              className="track-line" 
              d="M -50,300 C 180,120 100,500 340,420 C 490,380 280,720 80,820" 
              stroke="#ff5e3a" strokeWidth="2" fill="none" opacity="0.25" strokeDasharray="6 12" 
            />
            <path 
              d="M -50,300 C 180,120 100,500 340,420 C 490,380 280,720 80,820" 
              stroke="#ff5e3a" strokeWidth="0.75" fill="none" opacity="0.08" 
            />
            
            {/* Tracé Circuit Droite (Cyan) */}
            <path 
              className="track-line" 
              d="M 1490,600 C 1220,700 1280,320 1060,380 C 890,430 1080,120 1250,40" 
              stroke="#00d9ff" strokeWidth="2" fill="none" opacity="0.25" strokeDasharray="6 12" 
            />
            <path 
              d="M 1490,600 C 1220,700 1280,320 1060,380 C 890,430 1080,120 1250,40" 
              stroke="#00d9ff" strokeWidth="0.75" fill="none" opacity="0.08" 
            />
          </svg>
        </div>

        {/* Carte Latérale Gauche - F1 & MotoGP */}
        ...
        {/* Carte Latérale Droite - Danse & Running */}
        ...
        {/* Bloc de Contenu Principal (Lélia Perez) */}
        <div className="hero-main-content">
          ...
          <p
            className="hero-desc"
            style={{ fontSize: "15px", color: "rgba(255,255,255,0.45)", lineHeight: "1.75", maxWidth: "520px", margin: "0 auto 36px auto" }}
          >
